...
export default function Home() {
  ...
  useEffect(() => {
    async function fetchTotalUrls() {
      const res = await fetch('/api/getTotalUrls');
      const data = await res.json();
      setTotalUrls(data.data);
    }
    fetchTotalUrls();
  }, []);
  ...
  return (
    <div className={styles.main_home}>
      ...
      <div className={styles.home_top}>
        ...
        <p className={styles.home_top_heading}>
        ...
        <div className={styles.home_top_btn}>
          <button type="button" onClick={() => router.push('/shorten')} className={styles.button}>
            ...
            <span className={styles.text_button}>Generate Link</span>
          </button>
        </div>

        <div className={styles.home_top_stats}>
          <button className={styles.home_top_stats_btn}>
            <strong>{totalUrls ? `${totalUrls - 1}+` : '10+'}</strong> Links Shortened
      ...
      <div className={styles.home_bottom}>
        ...
        <div className={styles.home_bottom_heading}>
          Why QuickURL ?
        </div>
        <div className={styles.home_bottom_features}>
          <div className={styles.card}>
            <div className={styles.card__body}>
              Shorten and share instantly—no account or sign-in required.
            </div>
            <span>🚫 No Sign-In</span>
          </div>
          <div className={styles.card}>
            <div className={styles.card__body}>
              Trusted by creators, marketers, and developers.
            </div>
            <span>🌍 Trusted Globally</span>
          </div>
          <div className={styles.card}>
            <div className={styles.card__body}>
              Perfect for campaigns, bios, social media, and messaging.
            </div>
            <span>📣 Made for Sharing</span>
          </div>
          <div className={styles.card}>
            <div className={styles.card__body}>
              Your links are encrypted and safe from spam or misuse.
            </div>
            <span>🔒 Secure Links</span>
          </div>
          <div className={styles.card}>
            <div className={styles.card__body}>
              No fluff—just fast, reliable link shortening.
            </div>
            <span>⚡ Fast & Reliable</span>
          </div>
          <div className={styles.card}>
            <div className={styles.card__body}>
              Clean, minimal interface for max productivity.
            </div>
